...
public class Task {
    ...
    public Task(String videoId,long size, String name, String url,
    ...
    //dash
    public Task(String videoId,long size, String name, String url,String aUrl,
                int state, int chunks, String sdCardFolderAddress,
                boolean priority){
        this.id			= 0;
        this.videoId    = videoId;
    ...
    public ContentValues convertToContentValues(){
        ...
        contentValues.put(TASKS.COLUMN_VIDEO_ID,    videoId);
        ...
        contentValues.put(TASKS.COLUMN_AUDIO_URL,   aUrl);
        ...
        contentValues.put(TASKS.COLUMN_QUALITY,    quality);
        contentValues.put(TASKS.COLUMN_AUDIO_SIZE,    aSize);
        contentValues.put(TASKS.COLUMN_DASH,    isDash);
    ...
    public void cursorToTask(Cursor cr){
        ...
        videoId = cr.getString(
                cr.getColumnIndex(TASKS.COLUMN_VIDEO_ID));
        name = cr.getString(
        ...
        aUrl = cr.getString(
                cr.getColumnIndex(TASKS.COLUMN_AUDIO_URL));
        percent = cr.getInt(
        ...
        quality = cr.getString(
                cr.getColumnIndex(TASKS.COLUMN_QUALITY));
        aSize = cr.getDouble(
                cr.getColumnIndex(TASKS.COLUMN_AUDIO_SIZE));
        isDash = cr.getInt(
                cr.getColumnIndex(TASKS.COLUMN_DASH))>0;
