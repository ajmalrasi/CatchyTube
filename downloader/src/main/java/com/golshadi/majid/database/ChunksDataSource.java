...
//            System.out.println("ChunckDataSource: Task size = "+task.size);
//            System.out.println("ChunckDataSource: Number of chunks = "+task.chunks);
//            System.out.println("ChunckDataSource: Chunk size = "+chunkSize);
...
//                System.out.println("ChunckDataSource: "+i+". Chunk begin = "+chunk.begin+" End = "+chunk.end);
                //chunk.percentage = (int) ((chunk.end - chunk.begin)*100);
