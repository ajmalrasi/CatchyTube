...
public class TASKS {
    ...
    public final static String COLUMN_VIDEO_ID  = "video_id";
    public final static String COLUMN_NAME      = "name";
    public final static String COLUMN_SIZE      = "size";
    public final static String COLUMN_STATE     = "state";
    public final static String COLUMN_URL       = "url";
    public final static String COLUMN_AUDIO_URL = "audio_url";
    public final static String COLUMN_AUDIO_SIZE = "audio_size";
    public final static String COLUMN_QUALITY = "quality";
    public final static String COLUMN_DASH = "is_dash";
