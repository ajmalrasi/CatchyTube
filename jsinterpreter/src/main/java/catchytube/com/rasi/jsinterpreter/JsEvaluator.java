...
import catchytube.com.rasi.interpreterinterface.JsEvaluatorInterface;
import catchytube.com.rasi.interpreterinterface.WebViewWrapperInterface;

import java.util.ArrayList;

public class JsEvaluator implements CallJavaResultInterface, JsEvaluatorInterface {
    public final static String JS_NAMESPACE = "JsEvaluator";
    private final static String JS_ERROR_PREFIX = "JsEvaluatorException";
