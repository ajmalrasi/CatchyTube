...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private final static String DATABASE_NAME = "com.catchytube.com.ajmal.rasi.extension.db";
    ...
    private final String CREATE_TABLE_TASKS =
            ...
            + TASKS.COLUMN_QUALITY + " VARCHAR( 128 ), "
            + TASKS.COLUMN_AUDIO_SIZE + " INTEGER, "
            + TASKS.COLUMN_DASH + " BOOLEAN, "
            ...
            + CHUNKS.COLUMN_PERCENTAGE + " INTEGER "
            + " ); ";
