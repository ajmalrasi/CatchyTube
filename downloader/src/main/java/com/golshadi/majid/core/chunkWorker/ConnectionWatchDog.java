...
public class ConnectionWatchDog extends Thread
{
	...
	public void run()
	{
		...
		while (!Thread.currentThread().isInterrupted())
		{
			...
			{ 
				Thread.sleep(m_rate);
				//System.out.println("---"+Thread.currentThread().getId()+" Thread sleeping ..."+m_elapsed+" State = "+Thread.currentThread().getState());
			}
